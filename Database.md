...
2. [Резидентные](#Резидентные)
3. [Реляционные](#Реляционные)
4. [С широкими столбцами](#с-широкими-столбцами)
5. [Столбчатые(колончатые) базы данных](#столбчатыеколончатые-базы-данных)
6. [Документоориентированные базы данных](#Документоориентированные-базы-данных)
7. [Графовые базы данных](#Графовые-базы-данных)
