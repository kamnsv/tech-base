...
> **Примеры**: etc/passwd и etc/fstab; файлы: csv, ini, toml, json и др.
...
* Обычно это хэш-таблица или столбцы.
...
* Данные хранятся в столбцах.
* Получение доступа без помощи ключей.
