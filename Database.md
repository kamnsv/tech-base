...
5. [Столбчатые(колончатые) базы данных](#столбчатыеколончатые)
6. [Документоориентированные базы данных](#документоориентированные)
7. [Графовые базы данных](#графовые)
