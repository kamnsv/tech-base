...
Примеры
> etc/passwd и etc/fstab, файлы csv, ini, toml, json и др.
...
* Реляционные: MySQL, Oracle DB, PostgreSQL.
* Резидентные: Redis, Apache Ignite, Tarantool.
* Поисковые: Elastic.
* С широкими столбцами: Cassandra, Google BigTable, HBase
